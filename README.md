<html>
 ...
 <body style="background-color:lightgray;">
   ...
   <p style="color:darkblue;border:2px solid green ">
     1 information and technology<br>
     ...
     6 network engineering Cybersecurity<br>
     7 AI and data science<br></p>
 ...
 The College of Science and Technology (CoST) was established at the same time as the The University of Cambodia in 2013.B</p>
   ...
   <img src="3.jpg" width="300" height="100">
 </body>
   <footer>
     <img src="7.jpg" width="50" height="50">
     college science and technology copyrigth@2024
   </footer>
 </html>
